...
<b style='font-size:22px' class='w3-margin-left'>Muat Naik Data Murid</b>
</div>

<div class='w3-container w3-white w3-center'>
    <form style='color:#5E60CE' class='w3-margin w3-text-deep-purple' action='' method='POST' action='upload.php' enctype='multipart/form-data'>
        Pilih Fail CSV untuk di muat naik:<br> 
        <input type='file' name='file' required/>
        <button style='background-color:#56CFE1;color:#ffffff' class='w3-margin-top w3-card w3-button w3-round-xlarge' type='submit' name='btn-upload' >Muat Naik</button> 
    </form> 
</div>
