...
<button class='w3-right w3-margin-left w3-round-xxlarge w3-card w3-border-amber' style='font-size:20px; background-color:#FFC300' onclick="playAudio()" type="button">🎵</button>
